function mfp(){
  ...
  var strongName;
  try {
    unflattenKeylistIntoAnswers([$intern_44], $intern_51);
    unflattenKeylistIntoAnswers([$intern_42], $intern_52);
    unflattenKeylistIntoAnswers([$intern_43], $intern_53);
    unflattenKeylistIntoAnswers([$intern_38], $intern_54);
